...
export default function Footer() {
   ...
   return (
      <footer className="w-full mt-auto pt-24 pb-12 border-t border-stone-200/60 bg-[#FDFBF7] relative z-10 font-sans">
         {/* --- TEXTURE DE FOND (Effet subtil) --- */}
         <div className="absolute inset-0 opacity-[0.03] bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] pointer-events-none"></div>

         <div className="max-w-[90rem] mx-auto px-6 md:px-12 relative z-20">

            {/* ============================================================= */}
            {/* GRILLE PRINCIPALE (4 colonnes : Marque, Navigation, Crédits, Juridique) */}
            {/* ============================================================= */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
               ...
               {/* --- COLONNE 3 : CRÉDITS & TECHNOLOGIES --- */}
               <div className="lg:col-span-3 space-y-6">
                  <h5 className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-400">
                     Crédits & Tech
                  </h5>
                  {/* Liste des sources de données et technologies */}
               ...
               {/* --- COLONNE 4 : INFORMATIONS JURIDIQUES --- */}
            ...
            {/* ============================================================= */}
            {/* BARRE DU BAS (Copyright & Lien GitHub) */}
            {/* ============================================================= */}
