// =================================================================================
// COMPOSANT : GAME CARD
// Rôle : Affiche un jeu et sa grille de progression 10x10.
// =================================================================================

// Palette de couleurs pour les Meeples
const MEEPLE_COLORS = {
...
export default function GameCard({ item, gameInfo, onRemove, onClickDetails, onRequestAddPlay, onOpenHistory }) {
   ...
   // Change la couleur du compteur selon l'avancement
