...
export default function Toast({ message, type = 'success', onClose }) {
   useEffect(() => {
      // Disparaît tout seul après 4 secondes
   ...
   const styles = {
      success: "bg-stone-900 text-amber-50 border-amber-600/50",
      error: "bg-red-900 text-white border-red-500/50"
   };
   ...
   return (
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-[100] animate-in slide-in-from-bottom-5 fade-in duration-300">
         <div className={`flex items-center gap-3 px-6 py-4 rounded-xl shadow-2xl border ${styles[type]} backdrop-blur-md min-w-[300px] max-w-md`}>
