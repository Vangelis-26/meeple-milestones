   ...
   return (
      <div className="min-h-screen flex flex-col relative font-sans text-stone-800 bg-[#E8E4DC] bg-paper-texture">
         ...
         <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
            ...
            <DecorativeMeeple color="#b91c1c" className="w-48 h-48 top-20 right-10 rotate-45" />
            <DecorativeMeeple color="#15803d" className="w-64 h-64 -bottom-10 left-20 -rotate-6" />
         </div>
