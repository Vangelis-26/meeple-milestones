...
export default function ForgotPassword() {
   ...
   const handleReset = async (e) => {
      ...
      try {
         ...
         setMessage("Si ce grimoire existe, un corbeau a été envoyé avec les instructions.");
      } catch (err) {
      ...
      <div className="min-h-screen w-full flex items-center justify-center bg-[#D6D1C3] relative overflow-hidden font-sans">
         ...
         <div className="relative z-10 w-full max-w-md px-6 animate-in fade-in zoom-in-95 duration-1000">
            ...
            <div className="text-center mb-8 flex flex-col items-center gap-6">
               <div className="relative w-24 h-24 drop-shadow-[0_20px_20px_rgba(0,0,0,0.35)]">
               ...
               <h1 className="flex flex-col items-center font-serif uppercase tracking-tighter leading-[0.85]">
                  <span className="font-light opacity-50 italic text-2xl text-stone-900">Sceau</span>
                  <span className="font-black text-3xl text-transparent bg-clip-text bg-gradient-to-br from-amber-600 via-amber-800 to-stone-900 whitespace-nowrap mt-1">
                     Oublié
                  </span>
               </h1>
            </div>
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-[2.5rem] p-8 md:p-10 shadow-2xl relative overflow-hidden border border-stone-200/50">
               ...
               {!message ? (
                  <form onSubmit={handleReset} className="relative z-10 space-y-7">
                     <p className="text-center text-stone-500 text-sm font-medium">
                        Entrez le nom de votre grimoire pour recevoir un nouveau sceau d'accès.
                     </p>
                  ...
                  <div className="relative z-10 text-center space-y-6 py-4">
                     ...
                     <p className="text-stone-800 font-serif font-bold text-lg">Corbeau envoyé !</p>
               ...
               <div className="mt-10 pt-8 border-t border-stone-100 flex flex-col items-center gap-3 relative z-20">
                  <Link
                     to="/login"
                     className="text-[11px] font-serif font-black text-amber-800 uppercase tracking-widest hover:text-amber-600 transition-colors border-b-2 border-amber-100 hover:border-amber-600 pb-0.5"
                  >
                     Retour à l'Antre
                  </Link>
               </div>
