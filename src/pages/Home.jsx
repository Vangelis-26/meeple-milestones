...
export default function Home() {
   ...
   return (
      // CORRECTION ICI : min-h pour le scroll mobile, suppression de overflow-hidden
      <div className="min-h-[calc(100vh-64px)] w-full bg-paper-texture flex flex-col font-sans text-stone-800 relative overflow-y-auto justify-center items-center cursor-default selection:bg-amber-200 selection:text-amber-900 py-8">

         {/* --- MEEPLES DÉCORATIFS (Position Fixed pour rester jolis au scroll) --- */}
         ...
         <main className="flex-1 w-full flex flex-col items-center justify-center p-4 relative z-10">
            ...
            <div className="w-full max-w-xl shadow-2xl rounded-3xl overflow-hidden flex flex-col bg-white relative">
               ...
               {/* 1. BANNIÈRE IMAGE */}
               <div className="w-full h-52 md:h-72 bg-stone-800 relative">
                  <img
                     src="/title.webp"
               ...
               {/* 2. LE LOGO */}
               <div className="absolute top-36 md:top-56 left-1/2 transform -translate-x-1/2 z-20">
               ...
               <div className="bg-white px-8 pt-20 pb-10 flex flex-col items-center text-center">
                  ...
                  <div className="w-full bg-stone-50 border border-stone-200 rounded-2xl p-4 flex flex-col gap-4 mb-8 shadow-inner relative overflow-hidden">
                     ...
                     <div className="flex items-center justify-between w-full">
                        ...
                        <div className="relative z-20 flex-shrink-0 mx-2">
                           <img src="/token_x.webp" alt="X Token" className="w-16 h-16 object-contain drop-shadow-sm" />
                        </div>
                        <div className="flex flex-col items-center w-1/3 z-10">
                  ...
                  >
                     <span>{user ? "Accéder à mon tableau de bord" : "Commencer l'aventure"}</span>
                  </Link>
         ...
         <footer className="w-full text-center text-stone-400 text-xs font-medium font-serif italic z-10 mt-8">
